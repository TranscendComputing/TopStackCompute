...
@Component
public class DescribeInstancesWorkerTest extends AbstractBaseComputeTest
 implements ApplicationContextAware {

    private final static Logger logger = Appctx
            .getLogger(DescribeInstancesWorkerTest.class.getName());

    private static final int MAX_WAIT_SECS = 3000;
    ...
    public void testValidJob() throws Exception
    {
        ...
        client.dispatch("DescribeInstancesIn", req.build(), null);
        ...
        if (listener.error != null) {
            logger.error("An error was returned from the call:" + listener.error.getCode());
